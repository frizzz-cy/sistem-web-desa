        ...
        <div style="overflow-x: auto; -webkit-overflow-scrolling: touch; width: 100%; margin-top: 10px;">
            <table>
                ...
                <tbody>
                            ...
                            @if(auth()->user()->isAdmin())
                                <div style="display: flex; align-items: center; gap: 8px;">
                                    <label class="switch-toggle" title="Klik untuk sembunyikan/tampilkan dari publik">
                                        <input type="checkbox" onchange="handleVisibilityToggle('/admin/berita/{{ $item->id }}/toggle-visibility', this)" {{ !$item->is_hidden ? 'checked' : '' }}>
                    ...
                    @empty
                    <tr>
                        <td colspan="7" style="text-align: center; color: #64748B; padding: 30px;">Belum ada berita yang ditulis.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
