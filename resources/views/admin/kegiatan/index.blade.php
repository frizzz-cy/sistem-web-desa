...
<head>
    ...
    <title>Kelola Galeri & Kegiatan - Admin Desa</title>
...
<body>
    <div class="container">
        ...
        <div class="admin-nav" style="display: flex; gap: 8px; border-bottom: 2px solid #E2E8F0; margin-bottom: 24px; padding-bottom: 1px;">
            ...
            <a href="/admin/kegiatan" class="admin-nav-item" style="padding: 10px 16px; font-weight: 700; text-decoration: none; color: #1668A3; border-bottom: 2px solid #1668A3; margin-bottom: -2px; font-size: 14px;">Galeri & Kegiatan</a>
        </div>
