...
<div class="login-wrapper">
  ...
  <!-- Munculkan peringatan jika password/username salah -->
  @if($errors->any())
    <div class="alert">
      {{ $errors->first() }}
    </div>
  ...
  <form action="/login" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" id="login_field" name="login_field" placeholder="admintest / admin@desa.id" value="{{ old('login_field') }}" required autofocus>
    </div>
    <div class="form-group">
